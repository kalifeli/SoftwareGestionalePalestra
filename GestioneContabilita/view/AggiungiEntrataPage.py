...
class AggiungiEntrataPage(ctk.CTkFrame):
    def __init__(self, master, controller, back_callback):
        ...
        title = ctk.CTkLabel(self, text="Aggiungi Entrata", font=ctk.CTkFont(size=24, weight="bold"))
        ...
        self.importo_entry = ctk.CTkEntry(self, placeholder_text="Importo (es. 29.99)")
        ...
        salva_btn = ctk.CTkButton(self, text="Salva Entrata", command=self._on_salva)
    ...
    def _on_salva(self):
        ...
        try:
            ...
            self.controller.aggiungi_entrata(descrizione, importo, data_formattata, tipo)
            self.back_callback()
